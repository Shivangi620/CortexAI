export const ROUTES = [
  { path: "/overview", label: "Mission Control", step: "01", description: "Workspace, auth, live ops pulse, recent activity" },
  { path: "/data", label: "Data DNA", step: "02", description: "Ingest, QA, target detection, repair, lineage" },
  { path: "/training", label: "Training Deck", step: "03", description: "Forecast, configure, launch, watch reasoning" },
